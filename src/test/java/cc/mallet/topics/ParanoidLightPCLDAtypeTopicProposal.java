...
public class ParanoidLightPCLDAtypeTopicProposal extends LightPCLDAtypeTopicProposal {

	private static final long	serialVersionUID	= 6948198361119397002L;

	public ParanoidLightPCLDAtypeTopicProposal(LDAConfiguration config) {
		super(config);
	}
