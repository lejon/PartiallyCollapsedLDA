...
public class KeepConnectorPunctuationNumericAlsoTokenizer extends NumericAlsoTokenizer {

	private static final long serialVersionUID = 1L;

	public KeepConnectorPunctuationNumericAlsoTokenizer(int languageFlag) {
		super(languageFlag);
	}

	public KeepConnectorPunctuationNumericAlsoTokenizer(File stopfile) {
		super(stopfile);
	}

	public KeepConnectorPunctuationNumericAlsoTokenizer(HashSet<String> stoplist) {
		super(stoplist);
	}
	
	public KeepConnectorPunctuationNumericAlsoTokenizer(int languageFlag, int maxBufSize) {
		super(languageFlag, maxBufSize);
	}

	public KeepConnectorPunctuationNumericAlsoTokenizer(File stopfile, int maxBufSize) {
		super(stopfile, maxBufSize);
	}

	public KeepConnectorPunctuationNumericAlsoTokenizer(HashSet<String> stoplist, int maxBufSize) {
